        ...
        <div className="max-w-screen-xl mx-auto px-4 flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Link href="/portal/register"
              className="border border-[#c9a84c] text-[#c9a84c] px-4 py-2 rounded-full font-bold text-xs hover:bg-[#c9a84c] hover:text-white transition-all duration-300">
              Register
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white border-t border-gray-100 py-2 shadow-xl">
            ...
            <div className="px-4 py-3 border-t border-gray-100 mt-1 space-y-2">
              <Link href="/portal/register" onClick={() => setMobileMenuOpen(false)}
                className="block w-full text-center border-2 border-[#c9a84c] text-[#c9a84c] px-5 py-3 rounded-full font-bold text-sm hover:bg-[#c9a84c] hover:text-white transition-colors">
                Register / Registrarse
              </Link>
              <Link href="/portal/login" onClick={() => setMobileMenuOpen(false)}
                className="block w-full text-center border-2 border-[#1a3a5c] text-[#1a3a5c] px-5 py-3 rounded-full font-bold text-sm hover:bg-[#1a3a5c] hover:text-white transition-colors">
