...
export async function POST(req: Request) {
  ...
  await sendEmail({
    to: email,
    subject: "Reset your Casai password",
    html: `
      <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto">
        <h2 style="color:#1a3a5c">Password Reset</h2>
        <p>Hi ${user.name},</p>
        <p>Someone requested a password reset for your Casai account. Click the button below to set a new password:</p>
        ...
        <p style="color:#999;font-size:12px">Casai · Catherine Gomez Realtor</p>
      </div>
    `,
  })
